...
export default function TermsPage() {
  return (
    <div className="min-h-screen p-4 md:p-8 pb-24">
      {/* Back Button */}
      <Link href="/" className="inline-flex items-center gap-2 text-cyan-700 dark:text-white hover:text-orange transition-colors mb-8">
      ...
      <div className="max-w-4xl mx-auto glass-card p-8 space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">2. Services Provided</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">3. Account Registration</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed">
        ...
        <section>
          ...
          <div className="space-y-4 text-slate-700 dark:text-white/80 leading-relaxed">
            <p>
              <strong className="text-slate-900 dark:text-white">Pricing:</strong> Training session prices and subscription fees are as displayed on our pricing page. We reserve the right to change pricing with 30 days notice to active subscribers.
            </p>
            <p>
              <strong className="text-slate-900 dark:text-white">Payment:</strong> Payment is required at the time of booking for individual sessions or upfront for training packages and subscriptions.
            </p>
            <p>
              <strong className="text-slate-900 dark:text-white">Refunds:</strong> Session cancellations made at least 24 hours in advance are eligible for rescheduling or credit. No-shows or cancellations within 24 hours are non-refundable. Training packages are non-refundable but may be paused for injuries (with documentation).
            </p>
            <p>
              <strong className="text-slate-900 dark:text-white">Subscriptions:</strong> Monthly subscriptions automatically renew unless cancelled at least 7 days before the next billing cycle.
            </p>
          </div>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">5. Cancellation and Scheduling</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">6. Assumption of Risk and Liability</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mb-4">
          ...
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mt-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">7. PSP.Pro Platform Usage</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">9. Performance Data</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed">
        ...
        <section>
          ...
          <div className="mt-4 space-y-2 text-slate-700 dark:text-white/80">
            <p>
            ...
            <p>
              <strong className="text-slate-900 dark:text-white">Address:</strong> Proper Sports Performance, Chesapeake, VA
            </p>
            <p>
              <strong className="text-slate-900 dark:text-white">Phone:</strong> (757) 377-2089
            </p>
          </div>
        </section>
