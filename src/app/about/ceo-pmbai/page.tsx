...
export default function PMBAIBioPage() {
  return (
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="text-center mb-16">
            <div className="inline-block mb-6 px-4 py-2 bg-accent/10 border border-accent/20 rounded-full">
              <span className="text-accent font-semibold">Co-CEO</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Loren is the man with the plan. Often seen with his cool gimbal, this talented artist is always sharing businesses coolest products and stories.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
            ...
            <div className="p-8 rounded-xl bg-dark-200/50 backdrop-blur-sm border border-accent/10 hover:border-accent/30 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <p className="leading-relaxed">
                  PMBAI is a story teller of todays time.
                </p>
                <p className="leading-relaxed">
                  He's constantly breaking into new trends while keeping it professional. Finding new ways to capture your audience while delivering higher ROI.
                </p>
              </div>
            </div>
            ...
            <div className="p-8 rounded-xl bg-dark-200/50 backdrop-blur-sm border border-secondary/10 hover:border-secondary/30 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <p className="leading-relaxed">
                  Addicted to blending movie cinematics with AI, this untapped avenue is the largest growing media force on the planet.
                </p>
              </div>
            </div>
          </div>
