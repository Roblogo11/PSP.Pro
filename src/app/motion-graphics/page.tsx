...
const navItems: NavItem[] = [
  { id: 'hero', label: 'Motion Graphics', icon: Home },
...
export default function MotionGraphicsPage() {
  ...
  useEffect(() => {
    ...
    // Also check after a brief delay (for Next.js client navigation)
    const timeout = setTimeout(checkHash, 100)
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              <div className="relative p-6 md:p-12 rounded-2xl bg-gradient-home overflow-hidden backdrop-blur-sm border border-white/10">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-white">Motion Graphics</span>
                  </div>

                  <h1 className="text-5xl lg:text-6xl font-bold text-white">
                    3D & AI-Rendered Visuals
                  </h1>

                  <p className="text-xl text-gray-200">
                    3D, motion graphics, and AI-rendered imagery designed to surprise and inspire. Our generative visual systems combine cutting-edge AI with human creativity.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <StatCard number="3D + AI" label="Rendered Visuals" />
                <StatCard number="Motion" label="Dynamic Graphics" />
                <StatCard number="Generative" label="Art Systems" />
              </div>

              <div className="p-6 rounded-xl bg-dark-100/80 backdrop-blur-sm border border-white/10">
                <h3 className="text-lg font-bold text-white mb-3">What We Create:</h3>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-accent mt-1">✓</span>
                    <span>AI-generated 3D visualizations</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-accent mt-1">✓</span>
                    <span>Dynamic motion graphics</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-accent mt-1">✓</span>
                    <span>Generative art systems</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-accent mt-1">✓</span>
                    <span>Platform-optimized animations</span>
                  </li>
                </ul>
              </div>
            </div>
...
function ExamplesPanel() {
  ...
  useEffect(() => {
    const fetchGallery = async () => {
      try {
        const response = await fetch(`/api/gallery?type=motion-graphics${selectedCategory !== 'all' ? `&category=${selectedCategory}` : ''}`)
      ...
      <div className="relative z-10 p-4 md:p-8 lg:p-16">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="relative p-6 md:p-12 rounded-2xl bg-gradient-home overflow-hidden backdrop-blur-sm border border-white/10">
            ...
            <div className="relative z-10 space-y-4 text-center">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="font-bold text-white">Motion Graphics Gallery</span>
              </div>
              ...
              <p className="text-lg text-gray-200 max-w-3xl mx-auto">
                Browse our portfolio of 3D renders, animations, and generative art.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <StatCard number="AI-Rendered" label="Professional Quality" />
          </div>
        </div>
      </div>
    </div>
              ...
              <div className="relative p-6 md:p-12 rounded-2xl bg-gradient-contact overflow-hidden backdrop-blur-sm border border-white/10">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <p className="text-lg text-gray-200">
                    Ready to bring your visuals to life with AI-powered motion graphics and 3D renders?
                    Send us your vision.
                  </p>
