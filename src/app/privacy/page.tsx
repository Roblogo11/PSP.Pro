  ...
  return (
    <div className="min-h-screen p-4 md:p-8 pb-24">
      ...
      <div className="max-w-4xl mx-auto glass-card p-8 space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">5. Sharing Your Information</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mb-4">
        ...
        <section id="ccpa">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">7. California Privacy Rights (CCPA/CPRA)</h2>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mb-4">
            If you are a California resident, you have the following rights under the California Consumer Privacy Act (CCPA) and California Privacy Rights Act (CPRA):
          </p>
          <ul className="list-disc list-inside text-slate-700 dark:text-white/80 space-y-2 ml-4">
            <li><strong className="text-slate-900 dark:text-white">Right to Know:</strong> Request disclosure of the personal information we collect, use, or share</li>
            <li><strong className="text-slate-900 dark:text-white">Right to Delete:</strong> Request deletion of your personal information</li>
            <li><strong className="text-slate-900 dark:text-white">Right to Correct:</strong> Request correction of inaccurate personal information</li>
            <li><strong className="text-slate-900 dark:text-white">Right to Opt-Out:</strong> Opt-out of the sale or sharing of personal information</li>
            <li><strong className="text-slate-900 dark:text-white">Right to Non-Discrimination:</strong> We will not discriminate against you for exercising your rights</li>
          </ul>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mt-4">
            <strong className="text-slate-900 dark:text-white">We do not sell your personal information</strong> to third parties, and we do not share it for cross-context behavioral advertising.
          </p>
          <p className="text-slate-700 dark:text-white/80 leading-relaxed mt-4">
