    ...
    <div className="flex min-h-screen">
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="command-panel p-8 md:p-12 mb-6">
          ...
          <p className="text-xl text-slate-700 dark:text-white mb-6">
            We&apos;ve received your message and we&apos;re excited to help you reach your athletic goals!
          </p>

          <p className="text-slate-600 dark:text-white/80 mb-8">
          ...
          {/* What Happens Next */}
          <div className="mt-10 pt-8 border-t border-cyan-200/50 dark:border-cyan-700/30">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">What Happens Next?</h2>
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="p-4 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200/60 dark:border-cyan-700/30">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">We Review</h3>
                <p className="text-sm text-slate-600 dark:text-white/80">
                  Our team reviews your request and prepares a personalized response.
                </p>
              </div>

              <div className="p-4 rounded-xl bg-orange-50 dark:bg-cyan-900/20 border border-orange-200/60 dark:border-cyan-700/30">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">We Reach Out</h3>
                <p className="text-sm text-slate-600 dark:text-white/80">
                  Expect a reply within 24 hours with next steps and scheduling options.
                </p>
              </div>

              <div className="p-4 rounded-xl bg-green-50 dark:bg-cyan-900/20 border border-green-200/60 dark:border-cyan-700/30">
                <div className="w-10 h-10 bg-green-500/10 rounded-lg flex items-center justify-center mb-3">
                  <span className="text-green-600 dark:text-green-400 font-bold">3</span>
                </div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">We Train</h3>
                <p className="text-sm text-slate-600 dark:text-white/80">
