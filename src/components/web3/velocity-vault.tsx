...
// Monthly training video - Update this each month
const MONTHLY_VIDEO_URL = 'https://roblogo.com/wp-content/uploads/2026/02/AI-vs-jobs-SMP.mp4' // Placeholder
const MONTHLY_VIDEO_MONTH = 'February 2026'
const MONTHLY_VIDEO_TITLE = 'Biomechanics of the Fastball'
const SIGNATURE_MESSAGE = 'Sign to unlock your free PSP.Pro training video'
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange/10 border border-orange/20 mb-4">
            ...
            <span className="text-sm font-medium text-orange">Free Monthly Training</span>
          </div>
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">
            Velocity Vault - {MONTHLY_VIDEO_MONTH}
          </h3>
          <p className="text-cyan-700 dark:text-white max-w-lg mx-auto">
            <strong className="text-white">{MONTHLY_VIDEO_TITLE}</strong> - Connect your wallet to unlock this month's exclusive training video from Coach Rachel. No signup required!
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -inset-[2px] rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange via-cyan to-orange animate-pulse" />
            {/* Glitch lines */}
                ...
                {!isUnlocked ? (
                  ...
                  >
                    ...
                    <div className="relative w-full h-full bg-dark-200">
                      ...
                      {/* Month Badge */}
                      <div className="absolute top-4 left-4 z-20 px-4 py-2 bg-orange/90 backdrop-blur-sm rounded-lg">
                        <p className="text-white text-sm font-bold">🎯 {MONTHLY_VIDEO_MONTH} - {MONTHLY_VIDEO_TITLE}</p>
                      </div>
                    </div>
                  </motion.div>
                )}
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-center sm:text-left">
                  <p className="text-white font-semibold">
                    {isUnlocked ? '🎯 Training Video Unlocked!' : 'Free Monthly Training Video'}
                  </p>
                  <p className="text-cyan-700 dark:text-white text-sm">
                    {isUnlocked
                      ? `${MONTHLY_VIDEO_MONTH} - Come back next month for more!`
                      : isConnected
                        ? 'Sign with your wallet to unlock this month\'s video'
                        : 'Connect your wallet to access free training content'}
                  </p>
                </div>
                ...
                {!isUnlocked && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-orange via-cyan to-orange bg-[length:200%_100%] animate-[gradient_3s_ease_infinite]" />
                    ...
                    <span className="relative flex items-center justify-center gap-2">
                      {isConnecting ? (
                        ...
                        <>
                          ...
                          <span>Unlock Training Video</span>
                        </>
                      )}
                    </span>
                  </button>
