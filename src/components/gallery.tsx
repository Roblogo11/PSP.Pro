...
const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    category: 'Training',
    thumbnail: '/images/psp pitcher.webp',
    url: '/images/psp pitcher.webp',
    description: '1-on-1 pitching mechanics breakdown with coach guidance',
  },
  {
    id: 2,
    type: 'image',
    ...
    category: 'Training',
    thumbnail: '/images/Costal At Bat.webp',
    url: '/images/Costal At Bat.webp',
  ...
  },
  {
    ...
    category: 'Training',
    thumbnail: '/images/Praticing Soccer Drills.webp',
    url: '/images/Praticing Soccer Drills.webp',
    description: 'Group speed and agility session on the field',
  },
  {
    id: 4,
    type: 'image',
    ...
    category: 'Facility',
    thumbnail: '/images/over the shoulder psp pitching.webp',
    url: '/images/over the shoulder psp pitching.webp',
    description: 'PSP indoor training facility pitching session',
  },
  {
    id: 5,
    type: 'image',
    title: 'Aerial Training View',
    category: 'Facility',
    thumbnail: '/images/Top View Soccer Traing.webp',
    url: '/images/Top View Soccer Traing.webp',
    description: 'Drone view of soccer training with agility cones',
  },
  {
    id: 6,
    type: 'image',
